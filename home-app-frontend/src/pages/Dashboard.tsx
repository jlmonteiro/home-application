...
import { IconShoppingCart, IconChevronRight, IconArrowRight, IconBasket } from '@tabler/icons-react'
import { useAuth } from '../context/AuthContext'
import { fetchLists, fetchUserPreferences } from '../services/api'
        ...
        {showShopping && (
          <Stack>
            ...
            <Paper withBorder radius="md" p="md" pos="relative">
              ...
              {!isLoading && pendingLists.length === 0 && (
        ...
        <Stack>
          ...
          <Paper withBorder p="md" radius="md">
            <Text size="sm" c="dimmed">
              More dashboard widgets coming soon, including family member activities,
              expiring coupons, and household tasks.
            </Text>
            {!showShopping && (
