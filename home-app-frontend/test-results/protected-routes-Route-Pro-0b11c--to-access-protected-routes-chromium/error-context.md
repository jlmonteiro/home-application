...
- Name: protected-routes.spec.ts >> Route Protection Integrity >> Authenticated user should be allowed to access protected routes
- Location: e2e/protected-routes.spec.ts:25:3
